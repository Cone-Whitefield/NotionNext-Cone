...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '立锥之地', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '用于存放oc设定', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hippocampal.vercel.app', // 网站地址
